package com.sitexa.lovechain.adapter;
...
import com.sitexa.lovechain.modules.dapp.dappcompany.DappCompanyDetailsActivity;
import com.sitexa.lovechain.modules.dapp.dappdetails.DappDetailsActivity;
import com.sitexa.lovechain.modules.dapp.paidanswer.questiondetails.QuestionDetailsActivity;
import com.sitexa.lovechain.modules.friendslist.friendsdetails.FriendsDetailsActivity;
import com.sitexa.lovechain.modules.news.newsdetails.WebNewsDetailsActivity;
import com.sitexa.lovechain.modules.transaction.redpacket.continueredpacket.ContinueRdPacketActivity;
import com.sitexa.lovechain.modules.transaction.redpacket.getredpacketdetails.GetRedPacketDetailsActivity;
...
import com.sitexa.lovechain.bean.QuestionListBean;
...
public class AdapterManger {
     ...
     */
    public static CommonAdapter getDappHeadAdapter(final Context context, List<DappCompanyBean.DataBean> mHeaderList) {
        mCommonAdapter = new CommonAdapter<DappCompanyBean.DataBean>(context, R.layout.item_application, mHeaderList) {
            @Override
            protected void convert(ViewHolder holder, final DappCompanyBean.DataBean dataBean, final int position) {
                ...
                holder.getConvertView().setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ActivityUtils.next((Activity) context, DappCompanyDetailsActivity.class, bundle);
                    }
                });
            }
        };
