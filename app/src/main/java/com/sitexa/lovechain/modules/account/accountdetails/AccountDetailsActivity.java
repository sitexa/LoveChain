...
import com.sitexa.lovechain.utils.ViewToImageUtils;
import com.sitexa.lovechain.view.CustomSlideToUnlockView;
...
import com.sitexa.lovechain.view.dialog.importprivatekeydialog.ImportPrivateKeyDialog;
import com.sitexa.lovechain.view.dialog.importprivatekeydialog.ImportPrivateKeyCallback;
...
import com.sitexa.lovechain.view.dialog.sharedialog.ShareCallback;
import com.sitexa.lovechain.view.dialog.sharedialog.ShareDialog;
                    ...
                    public void sure(final String password) {
                        if (MyApplication.getInstance().getUserBean().getWallet_shapwd().equals(PasswordToKeyUtils.shaCheck(password))) {
                            if (mImportPrivateKeyDialog == null) {
                                mImportPrivateKeyDialog = new ImportPrivateKeyDialog(AccountDetailsActivity.this, new ImportPrivateKeyCallback() {
                                    @Override
