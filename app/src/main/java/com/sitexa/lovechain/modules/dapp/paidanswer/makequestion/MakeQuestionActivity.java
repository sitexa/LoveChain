package com.sitexa.lovechain.modules.dapp.paidanswer.makequestion;
...
import com.sitexa.lovechain.blockchain.AskansDataManager;
...
import com.sitexa.lovechain.adapter.baseadapter.base.ViewHolder;
import com.sitexa.lovechain.bean.AnswerBean;
import com.sitexa.lovechain.bean.ApproveMessageBean;
import com.sitexa.lovechain.bean.AskMessageBean;
import com.sitexa.lovechain.bean.ChainAsktitleBean;
import com.sitexa.lovechain.bean.ChainOptionanswersBean;
import com.sitexa.lovechain.utils.AndroidBug5497Workaround;
import com.sitexa.lovechain.utils.DateUtils;
import com.sitexa.lovechain.utils.KeyBoardUtil;
...
import com.sitexa.lovechain.view.dialog.confimdialog.Callback;
import com.sitexa.lovechain.view.dialog.confimdialog.ConfirmDialog;
...
import com.sitexa.lovechain.view.textwatcher.FourMoneyTextWatcher;
                            ...
                            PasswordDialog mPasswordDialog = new PasswordDialog(MakeQuestionActivity.this, new PasswordCallback() {
                                ...
                                public void sure(final String password) {
                                    if (MyApplication.getInstance().getUserBean().getWallet_shapwd().equals(PasswordToKeyUtils.shaCheck(password))) {
                                        ...
                                        new AskansDataManager(MakeQuestionActivity.this, userPassword, new AskansDataManager.Callback() {
                                            @Override
                                            public void isApprove(String action) {
                                                if (action.equals(AskansDataManager.ACTIONAPPROVE)) {
                                                    new AskansDataManager(MakeQuestionActivity.this, userPassword, new AskansDataManager.Callback() {
                                                        @Override
                                                        public void isApprove(String action) {
                                                            if (action.equals(AskansDataManager.ACTIONASK)) {
                                                                toast(getString(R.string.make_question_success));
                                                                EventBus.getDefault().post("ok");
                                                                finish();
                                                            }
                                                        }
                                                    }).pushAction(AskansDataManager.OCTASKANSCONTRACT, AskansDataManager.ACTIONASK,
                                        ...
                                        }).pushAction(AskansDataManager.OCTCONTRACT, AskansDataManager.ACTIONAPPROVE, new Gson().toJson(new ApproveMessageBean(getIntent().getStringExtra("account"), AskansDataManager.OCTASKANSCONTRACT, StringUtils.addZero(mPropertyNumber.getText().toString().trim())+" OCT")), getIntent().getStringExtra("account"));
                                    } else {
