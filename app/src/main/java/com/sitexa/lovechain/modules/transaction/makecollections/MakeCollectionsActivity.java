...
import com.sitexa.lovechain.view.dialog.makecollectiondialog.MakeCollectionCallback;
import com.sitexa.lovechain.view.dialog.makecollectiondialog.MakeCollectionDialog;
import com.sitexa.lovechain.view.popupwindow.BasePopupWindow;
import com.sitexa.lovechain.view.textwatcher.MakeCollectionMoneyTextWatcher;
        ...
        switch (view.getId()) {
            ...
            case R.id.get_make_collections_code:
                if (mGetPropertyNumber.getText().toString().trim().length() == 0) {
                    ...
                    MakeCollectionDialog dialog = new MakeCollectionDialog(this, new MakeCollectionCallback() {
