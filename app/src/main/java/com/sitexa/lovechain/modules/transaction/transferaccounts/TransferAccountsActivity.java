...
import com.sitexa.lovechain.modules.transaction.transferaccounts.switchfriend.SwitchFriendActivity;
...
import com.sitexa.lovechain.view.textwatcher.TransferMoneyTextWatcher;
                        ...
                        public void sure(final String password) {
                            if (MyApplication.getInstance().getUserBean().getWallet_shapwd().equals(PasswordToKeyUtils.shaCheck(password))) {
                                ...
                                if (mSwitchProperty.getText().toString().equals("EOS")) {
                                    new EosDataManager(TransferAccountsActivity.this, userPassword).setCoinRate(coinRate).pushAction(
