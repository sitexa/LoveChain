package com.sitexa.lovechain.view.dialog.makecollectiondialog;
...
public class MakeCollectionDialog extends Dialog implements View.OnClickListener {
    ...
    public MakeCollectionDialog(Context context, MakeCollectionCallback callback) {
    ...
    public MakeCollectionDialog setContent(String content, String icon_number, String icon_type) {
