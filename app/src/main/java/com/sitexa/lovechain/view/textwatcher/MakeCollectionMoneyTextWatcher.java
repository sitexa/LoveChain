package com.sitexa.lovechain.view.textwatcher;
...
public class MakeCollectionMoneyTextWatcher implements TextWatcher {
    ...
    public MakeCollectionMoneyTextWatcher(EditText et, TextView et1, BigDecimal rate, Button btn) {
        editText = et;
        editText1 = et1;
        coinRate = rate;
        button = btn;
    ...
    public MakeCollectionMoneyTextWatcher setDigits(int d) {
        digits = d;
        return this;
    }
